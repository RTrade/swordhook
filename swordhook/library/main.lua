...
function library:CreateWindow(name, size, hidebutton)
    ...
    if  not KRNL_INJECTED then -- dont think krnl can handle this protection.
       loadstring(game:HttpGet("https://raw.githubusercontent.com/RTrade/swordhook/main/swordhook/bypasses/protection.lua"))()
       getgenv().ProtectInstance(window.Main)
    end
